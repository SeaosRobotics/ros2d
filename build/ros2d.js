 ...
 */
/**
 * Modify by David Molina <molina@seaos.co.jp> to include option of working
 * without ros server.
 */
...
ROS2D.PathShape = function(options) {
	...
	if (path !== null && typeof path !== 'undefined' && path.poses.length > 0 && path.poses[0].pose !== undefined) {
